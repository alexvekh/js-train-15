...
function calculateCircleArea(radius) {
  ...
  if (typeof radius !== "number") {
    console.log("Error: радіус не є числом");
    return null;
  }
...
function calculateHypotenuse(a, b) {
  ...
  if (typeof a !== "number" || typeof b !== "number") {
    console.log("Error: довжини катетів не є числами");
    return null;
  }
...
function roundObjectValues(obj) {
  ...
  const roundedEntries = entries.map(([key, value]) => {
    if (typeof value === "number") return [key, Math.round(value)];
    else return [key, value];
  });
  obj = Object.fromEntries(roundedEntries);
  return obj;
}
...
function calculateVolumeCylinder(radius, height) {
  ...
  if (typeof radius !== "number" || typeof height !== "number") {
    console.log("Error: один чи обидва з аргументів не є числом");
    return null;
  }
...
function sumPositiveNumbers(numbers) {
  ...
  for (let i = 0; i < numbers.length; i++) {
    if (Math.sign(numbers[i]) === 1) sum += numbers[i];
  }
  return sum;
}
...
function estimateInvestment(principal, interestRate, years) {
  ...
  if (typeof principal !== "number" || typeof interestRate !== "number" || typeof years !== "number") {
    console.log("Error: не всі аргументи є числами");
    return null;
  }
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  if (!Array.isArray(products)) {
    console.log("Error: products не є масивом");
    return null;
  }
  if (typeof maxPrice !== "number") {
    console.log("Error: maxPrice не є числом");
    return null;
  }
  let totalPrice = products.reduce((accum, obj) => {
    //console.log(accum, obj.price);
